...
#### 2. GlobalSearch.subjects
   Similar to the search function, returns the results in form of R data frame. That data frame returned contains subjects. In order to get subjects in the search results you must provide `entities` search parameter:
