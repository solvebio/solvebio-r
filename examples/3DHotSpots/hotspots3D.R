...
EGFR_sig_res = as.data.table(Dataset.query(
'solvebio:3DHotSpots/1.0.0-2017-01/SignificantResidues',
...
EGFR_swissprot = as.data.table(Dataset.query(
'SwissProt/1.0.0-2017-02/SwissProt', 
filters=genes_filter, fields = c('swissprot_id'), paginate=TRUE))
EGFR_swissprot
...
EGFR_sp_features = as.data.table(Dataset.query(
'SwissProt/1.0.0-2017-02/Features', 
...
cv_comb = as.data.table(Dataset.query(
  'ClinVar/3.7.4-2017-01-30/Combined', 
  filter=genes_filter, 
...
icgc_egfr <- as.data.table(Dataset.query(
